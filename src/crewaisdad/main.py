...
# from crewaisdad.crew import CrewaiSdad
...
#     try:
#         CrewaiSdad().crew().kickoff(inputs=inputs)
#     except Exception as e:
...
#     }
#     try:
#         CrewaiSdad().crew().train(n_iterations=int(sys.argv[1]), filename=sys.argv[2], inputs=inputs)
...
#     """
#     try:
#         CrewaiSdad().crew().replay(task_id=sys.argv[1])
...
#     try:
#         CrewaiSdad().crew().test(n_iterations=int(sys.argv[1]), eval_llm=sys.argv[2], inputs=inputs)
